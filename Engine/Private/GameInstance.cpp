...
AREAMGR CGameInstance::GetCurrentAreaMgr()
{
...
#pragma endregion
//
//#pragma region LOAD, READY MAP FUCTION
//HRESULT CGameInstance::Load_Map(_uint iLevelIndex, const _char* Map)
//{
//	//맵
...
//}
//
//HRESULT CGameInstance::Load_Mesh(const wstring& strPrototypeTag, const _char* pModelFilePath, _bool bInstance, _uint iLevelIndex)
//{
...
//		{
//			if (FAILED(Add_Prototype(iLevelIndex, strPrototypeTag,
...
//}
//
//HRESULT CGameInstance::Loading_Meshs(_uint iLevelIndex, const _char* Map)
//{
//
...
//}
//
//HRESULT CGameInstance::Loading_Navigation(_uint iLevelIndex, const _char* Map/*, _bool bForTool*/)
//{
...
//}
//
//HRESULT CGameInstance::Loading_Decal_Textures(_uint iLevelIndex, const _char* Map)
//{
...
//}
//
//HRESULT CGameInstance::Loading_Breakable(_uint iLevelIndex, const _char* Map)
//{
...
//
//
//HRESULT CGameInstance::Ready_Map(_uint iLevelIndex, const _char* Map)
//{
//	//어떤 맵을 소환 시킬 것인지?
...
//}
//
//HRESULT CGameInstance::Ready_Meshs(_uint iLevelIndex, const _char* Map)
//{
...
//}
//
//HRESULT CGameInstance::Ready_StaticMesh(_uint iObjectCount, const json& objects, string ModelName, _uint iLevelIndex, const _char* Map)
//{
...
//}
//
//HRESULT CGameInstance::Ready_StaticMesh_Instance(_uint iObjectCount, const json& objects, string ModelName, _uint iLevelIndex, const _char* Map)
//{
...
//}
//
//HRESULT CGameInstance::Ready_Nav(const _wstring strLayerTag, _uint iLevelIndex, const _char* Map)
//{
...
//}
//
//HRESULT CGameInstance::Ready_Static_Decal(_uint iLevelIndex, const _char* Map)
//{
...
//}
//
//HRESULT CGameInstance::Ready_Breakable(_uint iLevelIndex, const _char* Map)
//{
//	// JSON 경로
