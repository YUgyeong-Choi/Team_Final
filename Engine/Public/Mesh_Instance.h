...
public:
	...
	virtual HRESULT Initialize_Prototype(MODEL eType, ifstream& ifs, _fmatrix PreTransformMatrix);
...
public:
	static CMesh_Instance* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, MODEL eType, const aiMesh* pAIMesh, _fmatrix PreTransformMatrix);
	static CMesh_Instance* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, MODEL eType, ifstream& ifs, _fmatrix PreTransformMatrix);
