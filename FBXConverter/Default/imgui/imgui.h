...
enum ImGuiKey : int
{
    ...
    // (doewnload controller mapping PNG/PSD at http://dearimgui.com/controls_sheets)
...
struct ImFontAtlas
{
    ...
    IMGUI_API const ImWchar*    GetGlyphRangesChineseSimplifiedCommon();// Default + Half-Width + Japanese Hiragana/Katakana + set of 21000 CJK Unified Ideographs for common simplified Chinese
