...
#pragma region CY
	...
	enum MESHEFFECT_PASS_INDEX { ME_DEFAULT, ME_MASKONLY, ME_MASKNOISE, ME_UVMASK, ME_MASK_SCROLL_WB, ME_MASKONLY_WB, ME_SHOCKWAVE, ME_LOSTERGO, ME_END };
	...
	enum TRAILEFFECT_PASS_INDEX { TE_DEFAULT, TE_DROP, TE_BLOODDROP, TE_BASIC, TE_END };
...
#pragma region YG
	...
	{
		WAKEUP, TUTORIALDOOR, OUTDOOOR, FUOCO, FESTIVAL, FINAL
	};

	enum INTERACT_TYPE
	{
		TUTORIALDOOR, SHORTCUT, OUTDOOR, FESTIVALDOOR, FUOCO, INNERDOOR, RESTARTFUOCO, RESTARTFESTIVAL
	};
