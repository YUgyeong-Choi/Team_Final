...
#define MAKE_EFFECT(LEVEL, EC_NAME, PRESETPOSX, PRESETPOSY, PRESETPOSZ)\
		EFFECT_MANAGER->Make_EffectContainer(LEVEL, EC_NAME, _float3{ PRESETPOSX, PRESETPOSY, PRESETPOSZ})
