...
class CYGFloor final : public CGameObject
{
private:
	CYGFloor(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CYGFloor(const CYGFloor& Prototype);
	virtual ~CYGFloor() = default;
public:
...
public:
	static CYGFloor* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
