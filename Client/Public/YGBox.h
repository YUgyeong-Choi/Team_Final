...
class CYGBox final : public CGameObject
{
private:
	CYGBox(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CYGBox(const CYGBox& Prototype);
	virtual ~CYGBox() = default;
public:
...
public:
	static CYGBox* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
