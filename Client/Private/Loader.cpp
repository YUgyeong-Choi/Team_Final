...
HRESULT CLoader::Loading_For_CY()
{
	...
	//���ص��ɰŰ�����
	///* For.Prototype_Component_Texture_T_SubUV_Explosion_01_8x8_SC_HJS */ // sprite�� 
	...
	///* For.Prototype_Component_Texture_T_Mask_27_C_GDH */ // trail�� ����ũ �̹���
	...
	//	return E_FAIL;
	//
	///* For.Prototype_Component_Texture_T_Trail_01_C_GDH */ // trail�� ����ũ �̹��� 2..
	...
	//	return E_FAIL;
	//
	///* For.Prototype_Component_Texture_T_Slash_01_C_RSW */ // �Ƹ� trail�� ����� �̹��� 
