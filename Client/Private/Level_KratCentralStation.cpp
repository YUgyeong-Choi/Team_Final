...
//HRESULT CLevel_KratCentralStation::Load_Map(_uint iLevelIndex, const _char* Map)
//{
//	//맵
...
//}
//
//HRESULT CLevel_KratCentralStation::Load_Mesh(const wstring& strPrototypeTag, const _char* pModelFilePath, _bool bInstance, _uint iLevelIndex)
//{
...
//}
//
//HRESULT CLevel_KratCentralStation::Loading_Meshs(_uint iLevelIndex, const _char* Map)
//{
//
...
//}
//
//HRESULT CLevel_KratCentralStation::Loading_Navigation(_uint iLevelIndex, const _char* Map/*, _bool bForTool*/)
//{
...
//	return S_OK;
//}
//HRESULT CLevel_KratCentralStation::Loading_Decal_Textures(_uint iLevelIndex, const _char* Map)
//{
...
//}
//
//HRESULT CLevel_KratCentralStation::Loading_Breakable(_uint iLevelIndex, const _char* Map)
//{
...
//}
//
//HRESULT CLevel_KratCentralStation::Ready_StaticMesh(_uint iObjectCount, const json& objects, string ModelName, _uint iLevelIndex, const _char* Map)
//{
...
//}
//
//HRESULT CLevel_KratCentralStation::Ready_StaticMesh_Instance(_uint iObjectCount, const json& objects, string ModelName, _uint iLevelIndex, const _char* Map)
//{
...
//}
//
//HRESULT CLevel_KratCentralStation::Ready_Nav(const _wstring strLayerTag, _uint iLevelIndex, const _char* Map)
//{
...
//}
//
//HRESULT CLevel_KratCentralStation::Ready_Breakable(_uint iLevelIndex, const _char* Map)
//{
//	// JSON 경로
